...
var tml = {
  ...
  init: function(token, options, callback) {
    ...
    var intro = [];
    intro.push(" _______                  _       _   _             ______          _");
    intro.push("|__   __|                | |     | | (_)           |  ____|        | |");
    intro.push("   | |_ __ __ _ _ __  ___| | __ _| |_ _  ___  _ __ | |__  __  _____| |__   __ _ _ __   __ _  ___");
    intro.push("   | | '__/ _` | '_ \\/ __| |/ _` | __| |/ _ \\| '_ \\|  __| \\ \\/ / __| '_ \\ / _` | '_ \\ / _` |/ _ \\");
    intro.push("   | | | | (_| | | | \\__ \\ | (_| | |_| | (_) | | | | |____ >  < (__| | | | (_| | | | | (_| |  __/");
    intro.push("   |_|_|  \\__,_|_| |_|___/_|\\__,_|\\__|_|\\___/|_| |_|______/_/\\_\\___|_| |_|\\__,_|_| |_|\\__, |\\___|");
    intro.push("                                                                                       __/ |");
    intro.push("                                                                                      |___/");
    console.log(intro.join("\n"));

    if (options.element || options.document) {
      var container = (typeof options.element === "string") ? document.getElementById(options.element) : options.element;
      if (options.document) container = document.documentElement;
      tml.root_element = {
        container: container,
        content: container.innerHTML
      };

      if (tml.root_element.container.style)
        tml.root_element.container.style.display = "none";
    }

    // TODO: figure out the source
    // var source = options.source || location.href - split and be smart about it
    // wordpress/?page_id=7
    // /wordpress/page_id_7
    ...
    app.init(options, function(err) {
      ...
      if (tml.root_element) {
        ...
        if (tml.root_element.container.style)
          tml.root_element.container.style.display = "block";
      }
  ...
  translateElement: function(container, content) {
    ...
    var tokenizer = new DomTokenizer(element, {}, {
      debug: false,
