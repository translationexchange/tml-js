...
describe('DecorationTokenizer', function(){
  describe('creation', function(){
    it('should correctly split label into elements', function(){
      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[bold: Hello World]");
  ...
  describe('parsing', function(){
    it('should correctly split label into elements', function(){
      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("Hello World");
      ...
      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[bold: Hello [strong: World]]");
      ...
      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[bold1: Hello [strong22: World]]");
      ...
      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[bold: Hello, [strong: how] [weak: are] you?]");
      ...
      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[link] you have [italic: [bold: {count}] messages] [light: in your mailbox] [/link]");
  ...
  describe('substitution', function(){
    it('should correctly split label into elements', function(){
      ...
      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[bold]Hello World[/bold]");
      assert.deepEqual("<strong>Hello World</strong>", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[bold] Hello World [/bold]");
      assert.deepEqual("<strong> Hello World </strong>", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[p: Hello World]", {p: '<p>{$0}</p>'});
      assert.deepEqual("<p>Hello World</p>", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[p: Hello World]", {p: function(text) {
        return "<p>" + text + "</p>";
      }});
      assert.deepEqual("<p>Hello World</p>", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[link: you have 5 messages]", {link: '<a href="http://mail.google.com">{$0}</a>'});
      assert.deepEqual("<a href=\"http://mail.google.com\">you have 5 messages</a>", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[link: you have 5 messages]", {link: {href: "http://www.google.com"}});
      assert.deepEqual("<a href='http://www.google.com'>you have 5 messages</a>", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[link: you have {count || message}]", {link: {href: "http://www.google.com"}});
      assert.deepEqual("<a href='http://www.google.com'>you have {count || message}</a>", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[custom: you have {count || message}]");
      assert.deepEqual("you have {count || message}", tokenizer.substitute());

      var tokenizer = new Tr8n.Tokenizers.DecorationTokenizer("[custom: you have {count || message}]", {custom:1});
      assert.deepEqual("you have {count || message}", tokenizer.substitute());
